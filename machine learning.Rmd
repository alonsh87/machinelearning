...
```
##Decision
We can see we got the most accurate results, and by far, when using model 2, the random forest model. We got an accuracy of 0.9947 as opposed to 0.7 in the first model and 0.4984 in the third.
The expected out of sample error is 1-Accuracy = 0.0053. With such high accuracy we will expect to predict correctly most if not all of the test set.
